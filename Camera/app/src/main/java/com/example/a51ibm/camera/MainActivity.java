    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for (int i = 0; i < bmp.getWidth(); i++) {
                ...
                if (red(pixels[i])>100) {
                    //if (red(pixels[i])>green(pixels[i])) {
            ...
            canvas.drawText("RGB = " + red(pixels[160]) +"/"+ green(pixels[160]) +"/"+ blue(pixels[160]), 10, 140, paint1);
            canvas.drawText("RGB = " + red(pixels[480]) +"/" + green(pixels[480]) +"/" + blue(pixels[480]), 10, 160, paint1);
